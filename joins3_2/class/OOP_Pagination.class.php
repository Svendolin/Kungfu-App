...
class MyPagination {
    ...
    /* Eigenschaften (Properties) damit die Methoden zusammenschaffen können */
    ...
    function __construct($hostname,$username,$password,$db) {
        ...
        /* "Hilfs"-Methoden aufrufen und einpacken. Diese können wir dann geheim mit private weiter unten jeweils aufrufen */
    ...
    private function calculatePages() {
        ...
        $this -> numPages = ceil($this -> total /  $this -> numHits); // $this bezieht sich jeweils auf die entsprechende Methode
    }
    ...
    function makeTable() {
        ...
        $code .= "</table>";
        // Code zurück ans verarbeitende Skript leiten
        return $code;
    }
    ...
    /* Nachfolgend die drei Pagination Varianten, wieder jeweils in Methoden gepackt... */
